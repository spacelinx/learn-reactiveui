...
namespace ReactiveUI.Autofac
{
    ...
    public static class RegistrationExtensions
    {
        ...
        public static void RegisterViews(this ContainerBuilder builder, params Assembly[] assemblies)
        {
            ...
            var list = assemblies.First().DefinedTypes
                .Where(type => type.ImplementedInterfaces.Any(inter => inter == typeof(IViewFor)))
                .ToList();

            builder.RegisterAssemblyTypes(assemblies)
                    .Where(t => t.GetTypeInfo()
                    .ImplementedInterfaces.Any(i => i == typeof(IViewFor<>)))
